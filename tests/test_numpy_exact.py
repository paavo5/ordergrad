...
def test_lstat_presets_match_manual_vectors():
    ...
    presets = {
        ...
        "Quantile:0.25": np.array([0, 0, 0, 0, 0.75, 0.25], dtype=np.float64),
        "TopQuantile:0.25": np.array([0.25, 0.75, 0, 0, 0, 0], dtype=np.float64),
        "Quantile:0.1": np.array([0, 0, 0, 0, 0, 1], dtype=np.float64),
        "TopQuantile:0.1": np.array([1, 0, 0, 0, 0, 0], dtype=np.float64),
